...
import { ScrollRevealButton } from '@/components/Button-Reaveal';

import type { CameraAnimation, ParticleMesh } from '@/lib/types';
import { images, perspectives, cylinderConfig, particleConfig, imageConfig } from '@/lib/data';
import {
  drawImageCover,
  getPositionClasses,
...
import { cylinderVertex, cylinderFragment, particleVertex, particleFragment } from '@/lib/shaders';
